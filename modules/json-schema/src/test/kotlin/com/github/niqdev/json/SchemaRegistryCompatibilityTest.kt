  ...
  WordSpec({
    ...
    "SchemaRegistryCompatibility" should {
      ...
      "verify removed field" {
        ...
        JsonSchema(latestSchema).isCompatible(CompatibilityLevel.FORWARD, listOf(JsonSchema(previousSchema))) shouldBe
          listOf(
      ...
      "verify renamed field" {
        ...
        JsonSchema(latestSchema).isCompatible(CompatibilityLevel.BACKWARD, listOf(JsonSchema(previousSchema))) shouldBe
          listOf(
