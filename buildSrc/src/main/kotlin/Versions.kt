object Versions {
  ...
  const val aws = "2.20.18"
  const val awsKotlin = "0.21.1-beta"
  const val awsLambdaCore = "1.2.2"
  const val awsLambdaEvents = "3.11.0"
  const val arrow = "1.1.5"
  const val arrowMeta = "1.6.1"
  const val clikt = "3.5.2"
  const val confluent = "7.3.2"
  const val everit = "1.14.1"
  ...
  const val reactor = "3.5.3"
  const val reactorKotlin = "1.2.1"
